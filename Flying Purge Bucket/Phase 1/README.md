...
<br>
![Mount](Images/FPB_Mount_Short_Long.PNG)<br>
*(links kurzer Mount, rechts langer Mount)*<br>
<br>
Wenn du den langen Mount hast, dann sind die "_ Long" Dateien für dich relevant.<br>
<br>
Wenn du den kurzen Mount hast, dann sind es die "_ Short" Dateien.<br>
<br>
...
|Infill|Grid, Gyroid, Honeycomb,<br>Triangle oder Cubic|
|Infill %|min. 40%|
...
<br>
Die genaue Position an der Gantry kann je nach Druckraumgröße unterschiedlich sein.<br>
<br>
![Mount](Images/FPB_Mount_Position.PNG)<br>
<br>
# BOM - Phase 1
Vorausgesetzt du hast bereits einen Fixed-Klicky-Mount verbaut benötigst du:<br>
...
Falls du noch keinen Klicky-Mount hast, benötigst du zusätzlich:<br>
...
<br>
Falls das Druckteil hinter dem Bett weiter herunterfahren kann ohne das Bett zu berühren, senke die Gantry ab soweit bis die Nozzle auf Z0 ist.<br>
*(Abb. 1)*<br>
*oder*<br>
Falls das Druckteil auf dem Druckbett aufliegen würde, senkst du die Gantry so weit ab bis dies passiert.<br>
*(Abb. 2)*<br>
<br>

<hr>

![Pos01](Images/FPB_Vorbereitung_01.PNG)<br>
*(Abb. 1)*<br>
<br>

<hr>

![Pos02](Images/FPB_Vorbereitung_02.PNG)<br>
*(Abb. 2)*<br>
<br>
...
<br>
**Y_Max (`[stepper_y] @ position_max:`) laut Config?**<br>
<br>
...
<br>
**Höhe Druckbett-Oberfläche zur bed-support-extrusion (Oberfläche) (siehe Abb. 3)**<br>
<br>
**Welchen Abstand hat die Ober- oder Unterseite des Measuring-Adapter-Druckteil zur Druckbett-Oberfläche wenn deine Nozzle bei Z0 ist? (siehe Abb. 4)** *Bitte gib an ob du von der Oberseite des Measuring-Adapters gemessen hast oder von der Unterseite.*<br>
*oder*<br>
**Auf welchem Z Wert steht deine Nozzle wenn die Unterseite des Measuring-Adapter-Druckteil auf der Druckoberfläche aufliegt? (siehe Abb. 5)**<br>
<br>
<br>
...
![IMG01](Images/FPB_Messung_Abb01.PNG)<br>
...
![IMG02](Images/FPB_Messung_Abb02.PNG)<br>
...
![IMG03](Images/FPB_Messung_Abb03.PNG)<br>
...
![IMG04](Images/FPB_Messung_Abb04.PNG)<br>
...
![IMG05](Images/FPB_Messung_Abb05.PNG)<br>
